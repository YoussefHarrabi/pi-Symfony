...
class WorkController extends AbstractController
{
    ...
    public function index(WorkRepository $workRepository, PaginatorInterface $paginator, Request $request,Security $security): Response
    {
    ...
    public function new(Request $request, ValidatorInterface $validator,Security $security): Response
    {
        if ($security->getUser() === null) {
            // Redirect anonymous users to the login page
            return $this->redirectToRoute('app_login');
    ...
    public function update(Request $request, Work $work,Security $security): Response
    {
        if ($security->getUser() === null) {
            // Redirect anonymous users to the login page
            return $this->redirectToRoute('app_login');
    ...
    public function delete(Request $request, Work $work,Security $security): Response
    {
        if ($security->getUser() === null) {
            // Redirect anonymous users to the login page
            return $this->redirectToRoute('app_login');
    ...
    public function sendSms(Request $request, twilioo $twilioService,Security $security): Response
    {
        if ($security->getUser() === null) {
            // Redirect anonymous users to the login page
            return $this->redirectToRoute('app_login');
